...
<div class="card">
 ...
 <center>
 <h4> <div class="card-header"><b>{{$project->user->name}} {{$project->user->surname}} {{ \Carbon\Carbon::parse($project->date)->format('Y-m-d') }} ({{ \Carbon\Carbon::parse($project->date)->translatedFormat('l') }})</b> @if(!empty($showdayinview))
